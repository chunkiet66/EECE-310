...
public class TokenStream
{
    ...
    {
        this.lineno = lineno;
        if (sourceReader != null) {					// Given a Reader object
        	this.sourceReader = sourceReader;    	// Bug 1 - add this line
            this.sourceBuffer = new char[512];
            this.sourceEnd = 0;
        } else {									// Not given any Reader object
        ...
        for (;;) {
            ...
            if (c == '\\') {
                ...
                if (c == 'u') {
                    ...
                    stringBufferTop = 0;
                    //isUnicodeEscapeStart = true; 			// Bug 4
                } else {
            ...
            case '-':
                if (matchChar('=')) {
                    ...
                    //c = Token.ADD;		// Bug 2 - supposed to be subtract
                	c = Token.SUB;
                }
                return c;
