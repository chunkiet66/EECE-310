...
public class TokenStream
{
    ...
    private static int stringToKeyword(String name)
    {
        ...
        //else {				//changed
        	...
        	return Token.EOF;   //added
        }						//added
        
      //if (id == 0) { return Token.EOF; }  //bug1
        return id;
    }
    ...
    retry:
        for (;;) {
            ...
            if (isDigit(c) || (c == '.' && isDigit(peekChar()))) {
                ...
                double dval = 0;
                //int radix = base-1; 	//bug2
                int radix = base;		//changed
    ...
    //@ requires (stringBufferTop >= 0) && (stringBuffer !=null);
    //@ working_space \space(new char[stringBuffer.length * 2]);
    //@ assignable stringBuffer[stringBufferTop], stringBufferTop;
    ...
    // @ EECE310_TODO: Write requires, assignable, and ensures specs
    // @ requires ungetCursor != 0 && ungetBuffer != NULL;
    // @ assignable cursor, ungetCursor, ungetBuffer;
    ...
    //@ assignable sourceBuffer[stringBufferTop], lineStart, sourceEnd, sourceCursor;
     ...
     */
    //EECE310_TODO: Write requires, assignable, and ensures specs --- NOTE: No assignable because nothing is modified
    //@ requires tokenEnd > tokenBeg;
    //@ ensures ( ( (tokenEnd - tokenBeg) > 0 ) && (\result == tokenEnd - tokenBeg) );
